...
class CreateForeignKeys extends Migration {
	...
	public function up()
	{
		...
		Schema::table('cities', function(Blueprint $table) {
			$table->foreign('goveernarate_id')->references('id')->on('governorates')
						->onDelete('no action')
						->onUpdate('no action');
		});
		...
		Schema::table('client_post', function(Blueprint $table) {
			$table->foreign('favourite_post_id')->references('id')->on('favourite_posts')
						->onDelete('no action')
						->onUpdate('no action');
		});
	...
	public function down()
	{
		...
		Schema::table('cities', function(Blueprint $table) {
			$table->dropForeign('cities_goveernarate_id_foreign');
		});
		Schema::table('posts', function(Blueprint $table) {
			$table->dropForeign('posts_category_id_foreign');
		});
		Schema::table('favourite_posts', function(Blueprint $table) {
			$table->dropForeign('favourite_posts_category_id_foreign');
		});
		Schema::table('client_post', function(Blueprint $table) {
			$table->dropForeign('client_post_client_id_foreign');
		});
		Schema::table('client_post', function(Blueprint $table) {
			$table->dropForeign('client_post_favourite_post_id_foreign');
		});
		Schema::table('donation_requests', function(Blueprint $table) {
