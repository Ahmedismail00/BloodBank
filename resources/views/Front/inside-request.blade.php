                    ...
                    <div class="path">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">طلب التبرع: {{$donation_request->patient_name}}</li>
                            </ol>
                        </nav>
                    </div>
                    <div class="details">
                                ...
                                <div class="col-md-6">
                                    <div class="inside">
                                        <div class="info">
                                            ...
                                            <div class="light">
                                                <p dir="ltr">{{$bloodType->where('id',$donation_request->blood_type_id)->pluck('name')->first()}}</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="inside">
                                        <div class="info">
                                            ...
                                            <div class="light">
                                                <p>{{$donation_request->patient_age}} عام</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="inside">
                                        <div class="info">
                                            ...
                                            <div class="light">
                                                <p>{{$donation_request->bags_num}} أكياس</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
